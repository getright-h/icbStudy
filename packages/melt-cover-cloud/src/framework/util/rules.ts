...
export class RegExpRule {
  ...
  IDNo = /(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}$)|(^([A-Z]\d{6,10}(\(\w{1}\))?)$)|[A-Z][0-9]{6}\([0-9A]\)|([157][0-9]{6}\([0-9]\))|(^[a-zA-Z][0-9]{9}$)/; //身份证号
