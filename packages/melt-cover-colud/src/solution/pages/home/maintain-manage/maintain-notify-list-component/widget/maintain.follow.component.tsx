...
import { IModalComponentProps, schemaMaintainFollow } from '../maintain-notify-list.interface';
import style from '../maintain-notify-list.component.less';

export default function MaintainFollowComponent(props: IModalComponentProps) {
